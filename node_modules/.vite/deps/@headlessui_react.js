...
function o2() {
  let n7 = [], r9 = { addEventListener(e5, t17, s17, a13) {
    ...
    return n7.push(e5), () => {
      ...
      if (t17 >= 0) for (let s17 of n7.splice(t17, 1)) s17();
    };
  }, dispose() {
    for (let e5 of n7.splice(0)) e5();
  } };
  return r9;
}
...
function O(e5, r9, { sorted: t17 = true, relativeTo: l11 = null, skipElements: o12 = [] } = {}) {
  ...
  let E9 = (() => {
    ...
    if (r9 & 1) return 0;
    if (r9 & 2) return Math.max(0, n7.indexOf(l11)) - 1;
    if (r9 & 4) return Math.max(0, n7.indexOf(l11)) + 1;
    if (r9 & 8) return n7.length - 1;
    throw new Error("Missing Focus.First, Focus.Previous, Focus.Next or Focus.Last");
  })(), p7 = r9 & 32 ? { preventScroll: true } : {}, d13 = 0, a13 = n7.length, u10;
  do {
    if (d13 >= a13 || d13 + a13 <= 0) return 0;
    let s17 = x6 + d13;
    if (r9 & 16) s17 = (s17 + a13) % a13;
    else {
      if (s17 < 0) return 3;
      if (s17 >= a13) return 1;
    }
...
function h2(s17, m11, a13 = true) {
  ...
  function c14(e5, r9) {
    if (!i9.current || e5.defaultPrevented) return;
    let t17 = r9(e5);
    if (t17 === null || !t17.getRootNode().contains(t17) || !t17.isConnected) return;
    let E9 = function u10(n7) {
      return typeof n7 == "function" ? u10(n7()) : Array.isArray(n7) || n7 instanceof Set ? n7 : [n7];
    }(s17);
    for (let u10 of E9) {
      if (u10 === null) continue;
      let n7 = u10 instanceof HTMLElement ? u10 : u10.current;
      if (n7 != null && n7.contains(t17) || e5.composed && e5.composedPath().includes(n7)) return;
    }
...
function i3(t17) {
  var n7;
  if (t17.type) return t17.type;
  let e5 = (n7 = t17.as) != null ? n7 : "button";
  if (typeof e5 == "string" && e5.toLowerCase() === "button") return "button";
}
function s7(t17, e5) {
...
function y2(...t17) {
  ...
  let c14 = o4((e5) => {
    for (let o12 of n7.current) o12 != null && (typeof o12 == "function" ? o12(e5) : o12.current = e5);
  });
...
function F2({ container: e5, accept: t17, walk: r9, enabled: c14 = true }) {
  ...
  (0, import_react12.useEffect)(() => {
    ...
    for (; u10.nextNode(); ) p7(u10.currentNode);
  }, [e5, c14, o12, l11]);
}
...
function X({ ourProps: r9, theirProps: t17, slot: e5, defaultTag: a13, features: s17, visible: n7 = true, name: f14 }) {
  let o12 = N2(t17, r9);
  if (n7) return c3(o12, e5, a13, f14);
  let u10 = s17 != null ? s17 : 0;
  if (u10 & 2) {
    let { static: l11 = false, ...p7 } = o12;
    if (l11) return c3(p7, e5, a13, f14);
  }
  if (u10 & 1) {
...
function c3(r9, t17 = {}, e5, a13) {
  ...
  if (t17) {
    let i9 = false, m11 = [];
    for (let [y8, d13] of Object.entries(t17)) typeof d13 == "boolean" && (i9 = true), d13 === true && m11.push(y8);
    i9 && (p7["data-headlessui-state"] = m11.join(" "));
  }
  if (s17 === import_react13.Fragment && Object.keys(R(o12)).length > 0) {
    if (!(0, import_react13.isValidElement)(l11) || Array.isArray(l11) && l11.length > 1) throw new Error(['Passing props on "Fragment"!', "", `The current component <${a13} /> is rendering a "Fragment".`, "However we need to passthrough the following props:", Object.keys(o12).map((d13) => `  - ${d13}`).join(`
...
function w2(...r9) {
  return { ref: r9.every((t17) => t17 == null) ? void 0 : (t17) => {
    for (let e5 of r9) e5 != null && (typeof e5 == "function" ? e5(t17) : e5.current = t17);
  } };
}
function N2(...r9) {
  var a13;
  ...
  let t17 = {}, e5 = {};
  for (let s17 of r9) for (let n7 in s17) n7.startsWith("on") && typeof s17[n7] == "function" ? ((a13 = e5[n7]) != null || (e5[n7] = []), e5[n7].push(s17[n7])) : t17[n7] = s17[n7];
  if (t17.disabled || t17["aria-disabled"]) return Object.assign(t17, Object.fromEntries(Object.keys(e5).map((s17) => [s17, void 0])));
  for (let s17 in e5) Object.assign(t17, { [s17](n7, ...f14) {
    let o12 = e5[s17];
    for (let u10 of o12) {
      if ((n7 instanceof Event || (n7 == null ? void 0 : n7.nativeEvent) instanceof Event) && n7.defaultPrevented) return;
      u10(n7, ...f14);
    }
  } });
  return t17;
...
function R(r9) {
  ...
  for (let e5 in t17) t17[e5] === void 0 && delete t17[e5];
  return t17;
}
function g(r9, t17 = []) {
  let e5 = Object.assign({}, r9);
  for (let a13 of t17) a13 in e5 && delete e5[a13];
  return e5;
}
...
function r2(n7) {
  ...
  for (; e5 && !(e5 instanceof HTMLFieldSetElement); ) e5 instanceof HTMLLegendElement && (l11 = e5), e5 = e5.parentElement;
...
function i5(n7) {
  ...
  for (; e5 !== null; ) {
    if (e5 instanceof HTMLLegendElement) return false;
...
function e2(i9 = {}, s17 = null, t17 = []) {
  for (let [r9, n7] of Object.entries(i9)) o7(t17, f4(s17, r9), n7);
  return t17;
}
function f4(i9, s17) {
...
function o7(i9, s17, t17) {
  if (Array.isArray(t17)) for (let [r9, n7] of t17.entries()) o7(i9, f4(s17, r9.toString()), n7);
  else t17 instanceof Date ? i9.push([s17, t17.toISOString()]) : typeof t17 == "boolean" ? i9.push([s17, t17 ? "1" : "0"]) : typeof t17 == "string" ? i9.push([s17, t17]) : typeof t17 == "number" ? i9.push([s17, `${t17}`]) : t17 == null ? i9.push([s17, ""]) : e2(t17, s17, i9);
}
function p2(i9) {
  var t17, r9;
...
function m3(u10, t17) {
  ...
  (0, import_react16.useEffect)(() => {
    let o12 = [...e5.current];
    for (let [n7, a13] of t17.entries()) if (e5.current[n7] !== a13) {
      let l11 = r9(t17, o12);
...
var Ge = { [1](t17) {
  ...
  var e5;
  if ((e5 = t17.dataRef.current) != null && e5.disabled || t17.comboboxState === 0) return t17;
  ...
  var l11, b7, n7, d13;
  if ((l11 = t17.dataRef.current) != null && l11.disabled || (b7 = t17.dataRef.current) != null && b7.optionsRef.current && !((n7 = t17.dataRef.current) != null && n7.optionsPropsRef.current.static) && t17.comboboxState === 1) return t17;
  let e5 = ae(t17);
...
function We(t17, a13) {
  ...
  let c14 = (0, import_react19.useRef)(false), D6 = o4(() => {
    ...
    switch (C5.current = true, s17.key) {
      case o8.Enter:
        if (C5.current = false, o12.comboboxState !== 0 || c14.current) return;
      ...
      case o8.Tab:
        if (C5.current = false, o12.comboboxState !== 0) return;
    ...
    if (o12.labelId) return [o12.labelId].join(" ");
...
function qe(t17, a13) {
  ...
  let e5 = J("Combobox.Button"), r9 = Z("Combobox.Button"), l11 = y2(e5.buttonRef, a13), b7 = I(), { id: n7 = `headlessui-combobox-button-${b7}`, ...d13 } = t17, o12 = p(), i9 = o4((m11) => {
    ...
    if (r2(m11.currentTarget)) return m11.preventDefault();
    e5.comboboxState === 0 ? r9.closeCombobox() : (m11.preventDefault(), r9.openCombobox()), o12.nextFrame(() => {
      var c14;
      return (c14 = e5.inputRef.current) == null ? void 0 : c14.focus({ preventScroll: true });
    });
  }), O4 = i2(() => {
    if (e5.labelId) return [e5.labelId, n7].join(" ");
...
function to(t17, a13) {
  ...
  l(() => {
    if (!d13.__demoMode) return;
    let y8 = o2();
    return y8.requestAnimationFrame(() => {
      m11.current = true;
    }), y8.dispose;
  }, []), l(() => {
    if (d13.comboboxState !== 0 || !i9 || !m11.current || d13.activationTrigger === 0) return;
    let y8 = o2();
    return y8.requestAnimationFrame(() => {
      var E9, B3;
...
// node_modules/@headlessui/react/dist/components/focus-trap/focus-trap.js
function P(t17) {
  if (!t17) return /* @__PURE__ */ new Set();
  if (typeof t17 == "function") return new Set(t17());
  let r9 = /* @__PURE__ */ new Set();
  for (let e5 of t17.current) e5.current instanceof HTMLElement && r9.add(e5.current);
  return r9;
}
var J2 = "div";
...
function S4(t17, r9) {
  for (let e5 of t17) if (e5.contains(r9)) return true;
  return false;
}
...
function F3(p7) {
  let l11 = l5(), n7 = (0, import_react26.useContext)(v), e5 = n3(p7), [a13, o12] = (0, import_react26.useState)(() => {
    if (!l11 && n7 !== null || s.isServer) return null;
  ...
  return { before() {
    ...
    t17.microTask(() => {
      ...
      t17.addEventListener(o12, "click", (e5) => {
        if (e5.target instanceof HTMLElement) try {
...
function m7(e5) {
  let n7 = {};
  for (let t17 of e5) Object.assign(n7, t17(n7));
  return n7;
}
...
a8.subscribe(() => {
  ...
  for (let [t17] of e5) n7.set(t17, t17.documentElement.style.overflow);
...
function p6(e5, r9, n7) {
  ...
  return l(() => {
    if (!(!e5 || !r9)) return a8.dispatch("PUSH", e5, n7), () => a8.dispatch("POP", e5, n7);
  }, [r9, e5]), i9;
}
...
function h7(r9, l11 = true) {
  l(() => {
    ...
    function a13() {
      ...
      if (i9 === 1 ? t15.delete(e5) : t15.set(e5, i9 - 1), i9 !== 1) return;
      let n7 = u7.get(e5);
...
function j3({ defaultContainers: t17 = [], portals: r9, mainTreeNodeRef: u10 } = {}) {
  ...
  let o12 = (0, import_react29.useRef)((c14 = u10 == null ? void 0 : u10.current) != null ? c14 : null), l11 = n3(o12), f14 = o4(() => {
    var i9;
    let n7 = [];
    for (let e5 of t17) e5 !== null && (e5 instanceof HTMLElement ? n7.push(e5) : "current" in e5 && e5.current instanceof HTMLElement && n7.push(e5.current));
    if (r9 != null && r9.current) for (let e5 of r9.current) n7.push(e5);
    for (let e5 of (i9 = l11 == null ? void 0 : l11.querySelectorAll("html > *, body > *")) != null ? i9 : []) e5 !== document.body && e5 !== document.head && e5 instanceof HTMLElement && e5.id !== "headlessui-portal-root" && (e5.contains(o12.current) || n7.some((T8) => e5.contains(T8)) || n7.push(e5));
    return n7;
  });
...
function Ne2(t17, e5) {
  ...
  if (!N7 && !U5) throw new Error("You have to provide an `open` and an `onClose` prop to the `Dialog` component.");
  if (!N7) throw new Error("You provided an `onClose` prop to the `Dialog`, but forgot an `open` prop.");
  if (!U5) throw new Error("You provided an `open` prop to the `Dialog`, but forgot an `onClose` prop.");
  if (typeof n7 != "boolean") throw new Error(`You provided an \`open\` prop to the \`Dialog\`, but the value is not a boolean. Received: ${n7}`);
  if (typeof l11 != "function") throw new Error(`You provided an \`onClose\` prop to the \`Dialog\`, but the value is not a function. Received: ${l11}`);
...
function We2(t17, e5) {
  let o12 = I(), { id: i9 = `headlessui-dialog-overlay-${o12}`, ...n7 } = t17, [{ dialogState: l11, close: s17 }] = b3("Dialog.Overlay"), g6 = y2(e5), T8 = o4((a13) => {
    if (a13.target === a13.currentTarget) {
      if (r2(a13.currentTarget)) return a13.preventDefault();
...
function ne(e5, n7) {
  ...
  (0, import_react32.useEffect)(() => {
    if (!s17) return t17({ type: 2, buttonId: u10 }), () => {
  ...
  let D6 = o4((r9) => {
    var p7;
    if (s17) {
      if (l11.disclosureState === 1) return;
      switch (r9.key) {
        case o8.Space:
        case o8.Enter:
...
function o11(e5) {
  ...
  if (!(t17 instanceof HTMLElement)) return n7;
  let u10 = false;
  for (let f14 of t17.querySelectorAll('[hidden],[aria-hidden],[role="img"]')) f14.remove(), u10 = true;
...
function b4(c14) {
  ...
  return o4(() => {
    ...
    if (t17.current === u10) return r9.current;
...
var je3 = { [1](e5) {
  ...
  if (e5.dataRef.current.disabled || e5.listboxState === 0) return e5;
  ...
  var l11;
  if (e5.dataRef.current.disabled || e5.listboxState === 1) return e5;
...
function Xe3(e5, a13) {
  ...
  let n7 = I(), { id: r9 = `headlessui-listbox-button-${n7}`, ...l11 } = e5, t17 = U2("Listbox.Button"), p7 = _2("Listbox.Button"), u10 = y2(t17.buttonRef, a13), i9 = p(), b7 = o4((T8) => {
    ...
    if (r2(T8.currentTarget)) return T8.preventDefault();
    ...
    if (t17.labelId) return [t17.labelId, r9].join(" ");
...
function Ye3(e5, a13) {
  ...
  let P4 = o4((o12) => {
    switch (b7.dispose(), o12.key) {
      case o8.Space:
        if (t17.searchQuery !== "") return o12.preventDefault(), o12.stopPropagation(), p7.search(o12.key);
      case o8.Enter:
...
function et(e5, a13) {
  ...
  l(() => {
    if (u10.listboxState !== 0 || !b7 || u10.activationTrigger === 0) return;
    let A6 = o2();
  ...
  let y8 = o4((A6) => {
    if (l11) return A6.preventDefault();
    ...
    if (l11) return i9.goToOption(a2.Nothing);
...
function Ee(e5, u10) {
  ...
  let f14 = o4((n7) => {
    ...
    switch (m11.dispose(), n7.key) {
      case o8.Space:
        if (t17.searchQuery !== "") return n7.preventDefault(), n7.stopPropagation(), o12({ type: 3, value: n7.key });
      case o8.Enter:
...
function Pe2(e5, u10) {
  ...
  l(() => {
    if (o12.__demoMode || o12.menuState !== 0 || !l11 || o12.activationTrigger === 0) return;
    let T8 = o2();
  ...
  let g6 = o4(() => {
    ...
    if (s17) return T8.preventDefault();
    a13({ type: 1 }), D(o12.buttonRef.current);
  }), p7 = o4(() => {
    if (s17) return a13({ type: 2, focus: a2.Nothing });
...
function we3(t17, o12) {
  ...
  let { __demoMode: u10 = false, ...R3 } = t17, O4 = (0, import_react36.useRef)(null), n7 = y2(o12, T2((l11) => {
    ...
    if (!s17 || !p7) return false;
    for (let K4 of document.querySelectorAll("body > *")) if (Number(K4 == null ? void 0 : K4.contains(s17)) ^ Number(K4 == null ? void 0 : K4.contains(p7))) return true;
  ...
  let [S10] = (0, import_react36.useState)(() => Symbol()), i9 = y2(P4, o12, m11 ? null : (r9) => {
    ...
    if (m11) {
      ...
      case o8.Enter:
        ...
        break;
      case o8.Escape:
        if (n7.popoverState !== 0) return p7 == null ? void 0 : p7(n7.buttonId);
        if (!P4.current || E9 != null && E9.activeElement && !P4.current.contains(E9.activeElement)) return;
...
function Xe4(t17, o12) {
  ...
  let i9 = C(), a13 = (() => i9 !== null ? (i9 & d5.Open) === d5.Open : e5.popoverState === 0)(), E9 = o4((f14) => {
    ...
    switch (f14.key) {
      case o8.Escape:
        if (e5.popoverState !== 0 || !T8.current || S10 != null && S10.activeElement && !T8.current.contains(S10.activeElement)) return;
  ...
  (0, import_react36.useEffect)(() => {
    ...
    if (e5.__demoMode || !O4 || e5.popoverState !== 0 || !T8.current) return;
  ...
  let C5 = (0, import_react36.useMemo)(() => ({ open: e5.popoverState === 0, close: P4 }), [e5, P4]), H7 = { ref: m11, id: R3, onKeyDown: E9, onBlur: O4 && e5.popoverState === 0 ? (f14) => {
    ...
    function y8() {
      u(x6.current, { [s10.Forwards]: () => {
        ...
        for (let D6 of c14.slice()) if (D6.dataset.headlessuiFocusGuard === "true" || (B3 = e5.panel) != null && B3.contains(D6)) {
...
function qe4(t17, o12) {
  let u10 = (0, import_react36.useRef)(null), R3 = y2(u10, o12), [O4, n7] = (0, import_react36.useState)([]), e5 = y5(), v5 = o4((i9) => {
    ...
    for (let a13 of O4) a13.buttonId.current !== i9 && a13.close();
...
function we4(r9, o12) {
  ...
  let U5 = o4((c14) => {
    var _7;
    if (r2(c14.currentTarget)) return c14.preventDefault();
...
function te3(s17, n7) {
  let p7 = I(), { id: c14 = `headlessui-switch-${p7}`, checked: f14, defaultChecked: r9 = false, onChange: h11, name: l11, value: T8, form: b7, ...d13 } = s17, t17 = (0, import_react40.useContext)(y7), u10 = (0, import_react40.useRef)(null), D6 = y2(u10, n7, t17 === null ? null : t17.setSwitch), [o12, a13] = T4(f14, h11, r9), S10 = o4(() => a13 == null ? void 0 : a13(!o12)), C5 = o4((e5) => {
    if (r2(e5.currentTarget)) return e5.preventDefault();
...
function A5({ onFocus: n7 }) {
  ...
  return r9 ? import_react41.default.createElement(c4, { as: "button", type: "button", features: p3.Focusable, onFocus: (a13) => {
    ...
    function t17() {
      ...
      if (n7()) {
        if (cancelAnimationFrame(e5), !u10.current) return;
        o12(false);
        return;
      }
...
function d12(n7) {
  ...
  if (!t17) throw new Error("You must wrap your component in a <StableCollection>");
...
function f13() {
  ...
  if (!n7) return Symbol();
  let t17 = [], e5 = n7;
  for (; e5; ) t17.push(e5.index), e5 = e5.return;
  return "$." + t17.join(".");
}
...
var ce3 = { [0](e5, n7) {
  ...
  var r9;
  if (e5.tabs.includes(n7.tab)) return e5;
...
function me3(e5, n7) {
  ...
  l(() => {
    ...
    if (C5.current === void 0 || l11.tabs.length <= 0) return;
  ...
  return import_react42.default.createElement(C3, null, import_react42.default.createElement($4.Provider, { value: N7 }, import_react42.default.createElement(X4.Provider, { value: E9 }, E9.tabs.length <= 0 && import_react42.default.createElement(A5, { onFocus: () => {
    var p7, D6;
    for (let a13 of y8.current) if (((p7 = a13.current) == null ? void 0 : p7.tabIndex) === 0) return (D6 = a13.current) == null || D6.focus(), true;
    return false;
...
function ye4(e5, n7) {
  ...
  let y8 = m11 === R3, E9 = o4((a13) => {
    ...
    } })) === N.Success) return a13.preventDefault();
...
function l10(r9) {
  let e5 = { called: false };
  return (...t17) => {
    if (!e5.called) return e5.called = true, r9(...t17);
  };
}
...
function E8({ immediate: t17, container: s17, direction: n7, classes: u10, onStart: a13, onStop: c14 }) {
  ...
  l(() => {
    ...
    d13.add(r9.dispose);
    let i9 = s17.current;
    if (i9 && e5.current !== "idle" && l11.current) return r9.dispose(), a13.current(e5.current), r9.add(M9(i9, u10.current, e5.current === "enter", () => {
...
function Se4() {
  ...
  if (t17 === null) throw new Error("A <Transition.Child /> is used but it is missing a parent <Transition /> or <Transition.Root />.");
  return t17;
}
function Ne5() {
...
function se4(t17) {
  var r9;
  let n7 = {};
  for (let s17 of Pe5) n7[s17] = (r9 = t17[s17]) != null ? r9 : xe6;
  return n7;
}
function Re3(t17) {
...
function De4(t17, n7) {
  ...
  (0, import_react43.useEffect)(() => {
    if (G2 && l11 === "visible" && e5.current === null) throw new Error("Did you forget to passthrough the `ref` to the actual DOM node?");
  }, [e5, l11, G2]);
...
function He5(t17, n7) {
  ...
  l2();
  let p7 = C();
  if (r9 === void 0 && p7 !== null && (r9 = (p7 & d5.Open) === d5.Open), ![true, false].includes(r9)) throw new Error("A <Transition /> is used but it is missing a `show={true | false}` prop.");
